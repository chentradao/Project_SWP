...
<html>
    ...
    <body class="bg-gray-100">
            ...
            <div class="home">
                <div class="home_background parallax-window" data-parallax="scroll" data-image-src="P_images/Sale1.jpg" data-speed="0.8"></div>
                <div class="container">
                    <div class="row">
                        <div class="col">
        ...
        <div class="grid grid-cols-4 gap-4 p-4">
            ...
            <div class="bg-white p-4 rounded-lg shadow flex flex-col h-full">
                ...
                <div class="mt-auto">
                    ...
                    <button class="mt-2 w-full bg-red-500 text-white py-1 rounded">Mua Ngay</button>
                </div>
            </div>
