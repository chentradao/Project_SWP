        ...
        <div class="super_container">
            ...
            <header class="header">
                <div class="header_inner d-flex flex-row align-items-center justify-content-start">
                    ...
                    <nav class="main_nav">
                        <ul>
                            <li><a href="${pageContext.request.contextPath}/ProductDetailListServlet">Product</a></li>
            ...
            <div class="menu d-flex flex-column align-items-end justify-content-start text-right menu_mm trans_400">
                ...
                <div class="logo menu_mm"><a href="#">Estee Lauder</a></div>
                <div class="search">
                    <form action="#">
                                ...
                                <div class="col-lg-4 product_col">
                                    <div class="product">
                                        <div class="product_image">
                                            <img src="${productdetail.productImage}" alt="${productdetail.productName}">
                                        </div>
                                        ...
                                        <div class="product_content clearfix">
                                            <div class="product_info">
                                                <div class="product_name">
                                                    <a href="product-detail.jsp?productId=${productdetail.productId}">${productdetail.productName}</a>
                                                </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="gallery_title text-center">
                                    <ul>
                                        <li><a href="#">#estelauder</a></li>
                                        <li><a href="#">#esteelauderinstagram</a></li>
                                        <li><a href="#">#esteegirl</a></li>
                                    </ul>
                                </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col text-center">
                                <div class="footer_logo"><a href="homepage.jsp">Estée Lauder</a></div>
